              ...
              [
                ...
                t("ul", [
                  ...
                  t("li", [
                    t("p", [
                      a._v(
                        "打包的必要性：打包工具的存在主要就是为了处理模块化与合并请求，而以上两点基本解决这两个问题；再加之打包工具越来越复杂，工程复杂的情况下性能明显下降，其存在的必要性肯定也会引发质疑。"
                      ),
                    ]),
                  ]),
                ]),
                ...
                t("p", [
                  a._v(
                    "vite 等工具依靠现代浏览器的特性，除去了开发环境下的打包环节，减少了项目修改后等待代码打包的时间花费，加上尤大的亲自鼓吹站台，吸引了不少的用户。不过Webpack的强大以及模块化思想的实践还不是这些新生代工具一时半会可以替代的，最主要的原因是Webpack已经有了庞大的工程基础，例如vite这类的工具其实还是通过技术手段解决js语言编写的构建工具的性能瓶颈，我记得20年vueConf上，就有个老哥说：“我M1+64G运存，有必要吗？”，当时有点想笑，但感觉其实也是一个思路，如果从js语言性能瓶颈能够有所突破呢，Webpack的性能问题也就自然解决了。"
                  ),
                ]),
                a._v(" "),
                t("h2", { attrs: { id: "总结" } }, [
